...
def train_image_level(config):
    ...
    # TRAINING ASPECTS
    # the number of images per batch when training
    batch_size = config.get('batch_size', 4)
    # the number of patients per batch when performing patient-level evaluation
   ...
   # filter_attribute = 'Class_sample' if attribute == 'Class' else None
    ...
    checkpoint_base_path = os.path.join(get_mnt_path(), 'klaus/muscle-ultrasound/checkpoints')
